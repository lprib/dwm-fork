...
static const char *altbarcmd        = "$HOME/.config/polybar/launch.sh dwm"; /* Alternate bar launch command */
static const char *fonts[]          = { "monospace:size=10" };
static const char dmenufont[]       = "monospace:size=10";

// Default values if not found in xrdb:
...
static char selbgcolor_resource[]      = "dwm.lightText";
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask|ShiftMask, XK_space,  setlayout,      {.v = &layouts[3]} },
