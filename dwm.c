...
loadxrdb()
{
  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        XRDB_LOAD_COLOR(normbordercolor_resource, normbordercolor);
        XRDB_LOAD_COLOR(normbgcolor_resource, normbgcolor);
        XRDB_LOAD_COLOR(normfgcolor_resource, normfgcolor);
        XRDB_LOAD_COLOR(selbordercolor_resource, selbordercolor);
        XRDB_LOAD_COLOR(selbgcolor_resource, selbgcolor);
        XRDB_LOAD_COLOR(selfgcolor_resource, selfgcolor);
      }
    }
  }
